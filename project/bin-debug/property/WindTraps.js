...
var fly;
(function (fly) {
    var WindTraps = (function (_super) {
        __extends(WindTraps, _super);
        function WindTraps(x, y, width, height, op) {
        ...
        WindTraps.prototype.initBitmap = function (path) {
        ...
        WindTraps.prototype.onTrigger = function (pid) {
            var _this = this;
    ...
    fly.WindTraps = WindTraps;
    __reflect(WindTraps.prototype, "fly.WindTraps");
})(fly || (fly = {}));
//# sourceMappingURL=WindTraps.js.map